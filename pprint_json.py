...
def load_data(filepath):
    opened=open(filepath, encoding='UTF-8')
    s=opened.read()
    #null = None
    data=json.loads(s)
    t=json.dumps(data,sort_keys=True,indent=4, ensure_ascii = False)
    print(t)
